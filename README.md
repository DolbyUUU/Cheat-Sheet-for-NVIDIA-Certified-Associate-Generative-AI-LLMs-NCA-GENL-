...
The guide is available in both **English** and **Chinese**.

---

## About the NVIDIA NCA-GENL Certification

The **NVIDIA Certified Associate - Generative AI LLMs (NCA-GENL)** is an entry-level credential that validates a candidate's understanding of the foundational concepts for developing, integrating, and maintaining AI-driven applications using generative AI and large language models (LLMs) with NVIDIA solutions.

- **Official Certification Page:** [https://www.nvidia.com/en-us/learn/certification/generative-ai-llm-associate/](https://www.nvidia.com/en-us/learn/certification/generative-ai-llm-associate/)

The exam consists of two types of questions:
- **Single-choice questions** (approximately 75% of the exam)
- **Multiple-choice questions** (select two correct answers, approximately 25% of the exam)
...
- Prompt engineering and alignment techniques
- Data analysis, visualization, and preprocessing
- Experiment design and feature engineering
...
This cheat sheet places a strong emphasis on this area, as deep familiarity with tools beyond just CUDA is essential for success.
